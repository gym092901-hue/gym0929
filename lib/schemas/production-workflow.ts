...
export const ProductionScenePackageSchema = z.object({
  ...
  narration: z.string(),
  imageSource: z.enum(["local-template", "chatgpt-pro-manual", "uploaded", "openai-api"]),
...
export const ProductionWorkflowPackageSchema = z.object({
  ...
  imageGenerationMode: z.enum(["local-template", "local-template-or-chatgpt-pro-manual", "chatgpt-pro-manual"]),
  videoGenerationMode: z.enum(["local-remotion-motion", "local-remotion-or-veo3-or-uploaded-footage", "veo3-or-uploaded-footage"]),
