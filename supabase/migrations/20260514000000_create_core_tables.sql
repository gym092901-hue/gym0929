...
values
  ('premium_report', '우리 아이 심층 사주 리포트', 1990, 'KRW', '반려동물의 성향, 보호자와의 관계, 생활 루틴을 자세히 읽는 심층 리포트', true),
  ('guardian_match', '보호자와 우리 아이 궁합 리포트', 990, 'KRW', '보호자와 반려동물의 관계 스타일을 다정하게 읽는 추가 리포트', true),
  ('two_pet_match', '두 마리 궁합 리포트', 990, 'KRW', '두 반려동물의 관계 흐름과 생활 공간 조율 포인트', true),
  ('yearly_fortune', '2026년 연간 흐름 리포트', 990, 'KRW', '2026년의 계절별 생활 흐름과 월별 조언', true),
